...
# Domain Abfrage
DOMAIN = cConfig().getSetting('plugin_' + SITE_IDENTIFIER + '.domain', 'hdfilme.baby') # Domain Auswahl \xc3\x83\xc2\xbcber die xStream Einstellungen m\xc3\x83\xc2\xb6glich
...
def showEntries(entryUrl=False, sGui=False, sSearchText=False):
    ...
    for sInfo, sUrl, sName, sDummy in aResult:
        ...
        isQuality, sQuality = cParser.parseSingleResult(sDummy, 'quality-product">([^<]+)') # Qualit\xc3\x83\xc2\xa4t
