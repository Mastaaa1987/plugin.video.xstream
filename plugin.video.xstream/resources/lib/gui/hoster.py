...
class cHosterGui:
 ...
 try:
 # Sortiere Hoster nach Qualit\xc3\x83\xc2\xa4t (cConfig().getSetting('preferedQuality') == '5')
 ...
 # Sortiere Hoster nach Priorit\xc3\x83\xc2\xa4t
 ...
 # Sprache als Prio hinzugef\xc3\x83\xc2\xbcgt DWH 07.02.23 THX Cubikon
 if ranking:
 ...
 # F\xc3\x83\xc2\xbcr Sitplugin einfach.to mit in automatische Abspielliste aufnehmen (Da Links bei der \xc3\x83\xc5\x93berpr\xc3\x83\xc2\xbcfung der Verf\xc3\x83\xc2\xbcgbarkeit gekickt werden)
 ...
 percent = (count + 1) plug plug2 plug3 sites sites0 test.py test.sh test.txt xstream 100 // total
 try:
